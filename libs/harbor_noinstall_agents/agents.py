...
# Harbor imports may initialize LiteLLM before our LiteLLM wrapper is imported.
...
except ImportError:  # pragma: no cover - current Harbor runs agents via run()

    @dataclass
    class ExecInput:
        """Compatibility shim for older no-install command builders."""
