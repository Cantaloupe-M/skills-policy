  ...
  "Consumer Warranty #2440": [
    {
      ...
      "term_months": 12,
      "comments": "Kitchen line reserve",
      "account_number": 2440,
      "jun_adds": 12000,
      "jun_release": 3000,
      "jun_ending_balance": 9000.0,
      "jul_adds": 0,
      "jul_release": 3000,
      "jul_ending_balance": 6000.0,
      "aug_adds": 4000,
      "aug_release": 3500,
      "aug_ending_balance": 6500.0,
      "sep_adds": 0,
      "sep_release": 3500,
      "sep_ending_balance": 3000.0
    },
    {
      "entity": "Orion Laundry",
      "beginning_balance": 0.0,
      "term_months": 10,
      "comments": "Laundry reserve",
      "account_number": 2440,
      "jun_adds": 0,
      "jun_release": 0,
      ...
      "jul_adds": 10000,
      "jul_release": 2500,
      "jul_ending_balance": 7500.0,
      "aug_adds": 0,
      "aug_release": 2500,
      "aug_ending_balance": 5000.0,
      "sep_adds": 2000,
      "sep_release": 2500,
      "sep_ending_balance": 4500.0
    },
    {
      "entity": "Pulse Vacuums",
      "beginning_balance": 0.0,
      "term_months": 8,
      "comments": "Vacuum launch reserve",
      "account_number": 2440,
      "jun_adds": 8000,
      "jun_release": 2000,
      "jun_ending_balance": 6000.0,
      "jul_adds": 0,
      "jul_release": 2000,
  ...
  "Commercial Warranty #2445": [
    {
      ...
      "beginning_balance": 0.0,
      "term_months": 12,
      "comments": "HVAC contractor reserve",
      "account_number": 2445,
      "jun_adds": 20000,
      "jun_release": 4000,
      "jun_ending_balance": 16000.0,
      "jul_adds": 5000,
      "jul_release": 4500,
      "jul_ending_balance": 16500.0,
      "aug_adds": 0,
      "aug_release": 4500,
      "aug_ending_balance": 12000.0,
      "sep_adds": 0,
      "sep_release": 4500,
      "sep_ending_balance": 7500.0
    },
    {
      "entity": "Beacon Cooling",
      "beginning_balance": 0.0,
      "term_months": 6,
      "comments": "Summer install reserve",
      "account_number": 2445,
      "jun_adds": 0,
      "jun_release": 0,
      "jun_ending_balance": 0.0,
    ...
    {
      "entity": "Crest Boilers",
      "beginning_balance": 0.0,
      "term_months": 9,
      "comments": "Boiler retrofit reserve",
      "account_number": 2445,
      "jun_adds": 10000,
      "jun_release": 2500,
      "jun_ending_balance": 7500.0,
      "jul_adds": 0,
      "jul_release": 2500,
      "jul_ending_balance": 5000.0,
      "aug_adds": 3000,
      "aug_release": 2750,
      "aug_ending_balance": 5250.0,
      "sep_adds": 0,
      "sep_release": 2750,
      "sep_ending_balance": 2500.0
    }
  ]
}
MONTHS = ["jun", "jul", "aug", "sep"]
OUTPUT_FILENAME = 'Northstar_Warranty_Reserve_9-25.xlsx'
...
assert_true(normalize_formula(summary['B7'].value) == normalize_formula("'Consumer Warranty #2440'!" + f"{first_info[3]}{first_info[0]}"), 'Summary B7 mismatch')
assert_true(normalize_formula(summary['B8'].value) == normalize_formula("'Consumer Warranty #2440'!" + f"{first_info[3]}{first_info[1]}"), 'Summary B8 mismatch')
assert_true(normalize_formula(summary['B9'].value) == normalize_formula("'Consumer Warranty #2440'!" + f"{first_info[3]}{first_info[2]}"), 'Summary B9 mismatch')
assert_true(normalize_formula(summary['B12'].value) == normalize_formula("'Commercial Warranty #2445'!" + f"{second_info[3]}{second_info[0]}"), 'Summary B12 mismatch')
assert_true(normalize_formula(summary['B13'].value) == normalize_formula("'Commercial Warranty #2445'!" + f"{second_info[3]}{second_info[1]}"), 'Summary B13 mismatch')
assert_true(normalize_formula(summary['B14'].value) == normalize_formula("'Commercial Warranty #2445'!" + f"{second_info[3]}{second_info[2]}"), 'Summary B14 mismatch')
