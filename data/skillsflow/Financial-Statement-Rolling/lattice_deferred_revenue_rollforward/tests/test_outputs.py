...
EXPECTED_ROWS = {
  "SaaS Rev #2300": [
    {
      "entity": "Atlas Support",
      "beginning_balance": 0.0,
      "term_months": 12,
      "comments": "Annual SaaS contract",
      "account_number": 2300,
      "may_adds": 48000,
      "may_release": 12000,
      "may_ending_balance": 36000.0,
      "jun_adds": 12000,
      "jun_release": 12000,
      "jun_ending_balance": 36000.0,
      "jul_adds": 0,
      "jul_release": 12000,
      "jul_ending_balance": 24000.0,
      "aug_adds": 8000,
      "aug_release": 12000,
      "aug_ending_balance": 20000.0
    },
    {
      "entity": "Birch Cloud",
      "beginning_balance": 0.0,
      "term_months": 12,
      "comments": "Mid-market renewal",
      "account_number": 2300,
      "may_adds": 36000,
      "may_release": 9000,
      "may_ending_balance": 27000.0,
      "jun_adds": 0,
      "jun_release": 9000,
      "jun_ending_balance": 18000.0,
      "jul_adds": 9000,
      "jul_release": 9000,
      "jul_ending_balance": 18000.0,
      "aug_adds": 0,
      "aug_release": 9000,
      "aug_ending_balance": 9000.0
    },
    {
      "entity": "Comet Analytics",
      "beginning_balance": 0.0,
      "term_months": 12,
      "comments": "Analytics platform",
      "account_number": 2300,
      "may_adds": 24000,
      "may_release": 6000,
      "may_ending_balance": 18000.0,
      "jun_adds": 0,
      "jun_release": 6000,
      "jun_ending_balance": 12000.0,
      "jul_adds": 0,
      "jul_release": 6000,
      "jul_ending_balance": 6000.0,
      "aug_adds": 0,
      "aug_release": 6000,
    ...
    },
    {
      ...
      "beginning_balance": 0.0,
      "term_months": 12,
      "comments": "Late-start subscription",
      "account_number": 2300,
      "may_adds": 0,
      "may_release": 0,
      "may_ending_balance": 0.0,
      "jun_adds": 30000,
      "jun_release": 7500,
      "jun_ending_balance": 22500.0,
      "jul_adds": 0,
      "jul_release": 7500,
  ...
  "Services Rev #2310": [
    {
      ...
      "beginning_balance": 0.0,
      "term_months": 4,
      "comments": "Quarterly enablement",
      "account_number": 2310,
      "may_adds": 15000,
      "may_release": 5000,
      "may_ending_balance": 10000.0,
      "jun_adds": 0,
      "jun_release": 5000,
      "jun_ending_balance": 5000.0,
      "jul_adds": 0,
      "jul_release": 5000,
    ...
    {
      "entity": "Foundry Launch",
      "beginning_balance": 0.0,
      "term_months": 3,
      "comments": "Implementation kickoff",
      "account_number": 2310,
      "may_adds": 0,
      "may_release": 0,
      "may_ending_balance": 0.0,
    ...
    {
      "entity": "Grove Migration",
      "beginning_balance": 0.0,
      "term_months": 4,
      "comments": "Migration bundle",
      "account_number": 2310,
      "may_adds": 9000,
      "may_release": 2250,
      "may_ending_balance": 6750.0,
      "jun_adds": 0,
      "jun_release": 2250,
      "jun_ending_balance": 4500.0,
      "jul_adds": 0,
      "jul_release": 2250,
      "jul_ending_balance": 2250.0,
      "aug_adds": 0,
      "aug_release": 2250,
      "aug_ending_balance": 0.0
    },
    {
      ...
      "jul_adds": 12000,
      "jul_release": 4000,
      "jul_ending_balance": 8000.0,
      "aug_adds": 0,
      "aug_release": 4000,
      "aug_ending_balance": 4000.0
    }
  ]
}
MONTHS = ["may", "jun", "jul", "aug"]
OUTPUT_FILENAME = 'LatticeWare_Deferred_Revenue_8-25.xlsx'
...
assert_true(normalize_formula(summary['B7'].value) == normalize_formula("'SaaS Rev #2300'!" + f"{first_info[3]}{first_info[0]}"), 'Summary B7 mismatch')
assert_true(normalize_formula(summary['B8'].value) == normalize_formula("'SaaS Rev #2300'!" + f"{first_info[3]}{first_info[1]}"), 'Summary B8 mismatch')
assert_true(normalize_formula(summary['B9'].value) == normalize_formula("'SaaS Rev #2300'!" + f"{first_info[3]}{first_info[2]}"), 'Summary B9 mismatch')
assert_true(normalize_formula(summary['B12'].value) == normalize_formula("'Services Rev #2310'!" + f"{second_info[3]}{second_info[0]}"), 'Summary B12 mismatch')
assert_true(normalize_formula(summary['B13'].value) == normalize_formula("'Services Rev #2310'!" + f"{second_info[3]}{second_info[1]}"), 'Summary B13 mismatch')
assert_true(normalize_formula(summary['B14'].value) == normalize_formula("'Services Rev #2310'!" + f"{second_info[3]}{second_info[2]}"), 'Summary B14 mismatch')
