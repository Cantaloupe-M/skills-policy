...
EXPECTED_ROWS = {
  "Field Comm Asset #1510": [
    {
      ...
      "term_months": 12,
      "comments": "Field team annual plan",
      "account_number": 1510,
      "jul_adds": 15000,
      "jul_release": 3000,
    ...
    },
    {
      ...
      "beginning_balance": 0.0,
      "term_months": 6,
      "comments": "Midyear territory expansion",
      "account_number": 1510,
      "jul_adds": 0,
      "jul_release": 0,
    ...
    {
      "entity": "Cedar Mobility",
      "beginning_balance": 0.0,
      "term_months": 8,
      "comments": "Mobility reseller plan",
      "account_number": 1510,
      "jul_adds": 9000,
      "jul_release": 2250,
      "jul_ending_balance": 6750.0,
      "aug_adds": 0,
      "aug_release": 2250,
      "aug_ending_balance": 4500.0,
      "sep_adds": 0,
      "sep_release": 2250,
      "sep_ending_balance": 2250.0,
      "oct_adds": 3000,
      "oct_release": 2250,
      "oct_ending_balance": 3000.0
    }
  ...
  "Partner Comm Asset #1515": [
    {
      "entity": "Delta Alliances",
      "beginning_balance": 0.0,
      "term_months": 12,
      "comments": "Strategic partner incentive",
      "account_number": 1515,
      "jul_adds": 18000,
      "jul_release": 3000,
    ...
    },
    {
      ...
      "beginning_balance": 0.0,
      "term_months": 4,
      "comments": "Launch partner program",
      "account_number": 1515,
      "jul_adds": 0,
      "jul_release": 0,
      "jul_ending_balance": 0.0,
...
OUTPUT_FILENAME = 'Solstice_Commission_Assets_10-25.xlsx'
...
assert_true(normalize_formula(summary['B7'].value) == normalize_formula("'Field Comm Asset #1510'!" + f"{first_info[3]}{first_info[0]}"), 'Summary B7 mismatch')
assert_true(normalize_formula(summary['B8'].value) == normalize_formula("'Field Comm Asset #1510'!" + f"{first_info[3]}{first_info[1]}"), 'Summary B8 mismatch')
assert_true(normalize_formula(summary['B9'].value) == normalize_formula("'Field Comm Asset #1510'!" + f"{first_info[3]}{first_info[2]}"), 'Summary B9 mismatch')
assert_true(normalize_formula(summary['B12'].value) == normalize_formula("'Partner Comm Asset #1515'!" + f"{second_info[3]}{second_info[0]}"), 'Summary B12 mismatch')
assert_true(normalize_formula(summary['B13'].value) == normalize_formula("'Partner Comm Asset #1515'!" + f"{second_info[3]}{second_info[1]}"), 'Summary B13 mismatch')
assert_true(normalize_formula(summary['B14'].value) == normalize_formula("'Partner Comm Asset #1515'!" + f"{second_info[3]}{second_info[2]}"), 'Summary B14 mismatch')
