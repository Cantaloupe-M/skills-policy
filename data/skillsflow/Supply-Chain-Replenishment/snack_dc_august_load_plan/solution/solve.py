#!/usr/bin/env python3
"""Solver for snack_dc_august_load_plan."""
import math
import sys
...
def main():
    ...
    headers = [
        'Item_Code', 'On_Floor_Cases', 'Daily_Sales_Cases_Per_Day', 'Current_Days_On_Hand',
    ...
    act_ws = out_wb.create_sheet('Load_Action_Summary')
    act_headers = ['Item_Code', 'Required_Delivery_Date', 'Pallets_Required', 'Additional_Cases_Needed', 'Earlier_Delivery_Required']
    ...
    output_file = output_root / 'snack_dc_august_load_plan.xlsx'
