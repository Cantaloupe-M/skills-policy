...
METRIC_LABEL = "closed work orders"
...
def main() -> None:
    ...
    payload = {
        "source_file": "field_service_data.csv",
        "filters": {
    ...
    md = f"""# Field Service Analyze Tollgate Brief

## Project Charter
- Domain objective: improve closed work orders under a DMAIC Analyze gate.
- Baseline value: {BASELINE:.0f}
- Target value: {TARGET:.0f}
- Current mean value (business days, 2025-01-04..2025-03-01): {mean_value:.2f}
- Operational impacts: missed service-level commitments, repeat truck rolls, higher contract penalty exposure, customer dissatisfaction escalations.
...
1. Finalize Analyze package and leadership readout (Owner: Regional Dispatch Lead, Due: 2025-03-18)
2. Launch weekly monitoring and exception review cadence (Owner: Service Delivery Manager, Due: 2025-03-28)
"""
